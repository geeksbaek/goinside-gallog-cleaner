...
####Q. 글과 댓글을 불러오는 중이라고만 뜨고 진행이 안돼요.
A. 작성한 게시물이 매우 많은 경우 시간이 걸릴 수 있습니다. 현재 게시물을 불러오는 작업은 작업 상황을 표시하지 않기 때문에 몇 분정도 기다려보시길 바랍니다. 테스트하는 시점에서 약 7만 개의 게시물을 불러오는데 약 7분 가량이 소요되었습니다.
